...
SQLITE_CONNECTION = 'sqlite:///%s/twitter/twitter_candidatos.db' % PROJECT_PATH

DATE_LOWER_LIMIT = datetime(year=2015, month=8, day=9)

DATE_UPPER_LIMIT = datetime(year=2015, month=10, day=25)
